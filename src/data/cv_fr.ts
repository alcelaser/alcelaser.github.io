...
export const experience: Experience[] = [
  {
    role: 'Chercheur et Auteur',
    company: 'Google Developer Group on Campus – Guido Carli',
    type: 'Recherche et Rédaction',
    period: '2026',
    bullets: [
      'Co-auteur de l\'article de recherche : "Anomaly Detection in Spacecraft Telemetry: An Ensemble Approach"',
      'Développement d\'un framework d\'ensemble hybride combinant Isolation Forest, un prédicteur temporel inspiré de Telemanom et une couche de méta-apprentissage XGBoost',
      'Travail avec le jeu de données ESA Anomaly Detection Benchmark, avec un accent sur l\'interprétabilité via l\'analyse d\'importance des caractéristiques arborescentes',
      'Rédaction d\'un article sur les implications éthiques de l\'IA dans les structures de pouvoir, ainsi que sur l\'avenir de l\'IA et son impact sur la société',
      'Rédaction de nombreux autres articles pour le blog du GDG on Campus - Guido Carli',
    ],
  },
  {
...
export const skills: Skill[] = [
  ...
  { name: 'Développement Full-Stack', category: 'programming' },
  { name: 'Développement d\'Applications Web', category: 'programming' },
  { name: 'Développement d\'Applications Mobiles', category: 'programming' },
  { name: 'Intégration d\'API', category: 'programming' },
  { name: 'Architecture Frontend', category: 'programming' },
  ...
  { name: 'Détection d\'Anomalies', category: 'ai' },
  { name: 'Méthodes d\'Ensemble', category: 'ai' },
  { name: 'XGBoost', category: 'ai' },
  { name: 'Analyse de Séries Temporelles', category: 'ai' },
  { name: 'Isolation Forest', category: 'ai' },
  { name: 'IA Explicable', category: 'ai' },
  { name: 'Analyse d\'Importance des Variables', category: 'ai' },
  { name: 'Analyse de Télémétrie', category: 'ai' },
  { name: 'Évaluation de Modèles', category: 'ai' },
  ...
  { name: 'Curation de Jeux de Données', category: 'tools' },
  { name: 'Conception Expérimentale', category: 'tools' },
  { name: 'Documentation Technique', category: 'tools' },
  { name: 'Benchmark de Recherche', category: 'tools' },
  { name: 'Collecte de Données en Laboratoire', category: 'tools' },
  ...
  { name: 'Rédaction Argumentative', category: 'writing' },
  { name: 'Commentaire Technologique', category: 'writing' },
  { name: 'Analyse Macroéconomique', category: 'writing' },
  { name: 'Analyse Philosophique', category: 'writing' },
  { name: 'Structuration Narrative', category: 'writing' },
  ...
  { name: 'Communication Interculturelle', category: 'soft' },
  { name: 'Prise de Parole en Public', category: 'soft' },
  { name: 'Pensée Stratégique', category: 'soft' },
];
...
export const awards: Award[] = [
  {
    title: 'LUISS Grand Challenge – 1ère Place',
    issuer: 'Poste Italiane & LUISS',
    detail: 'Cours et compétition universitaire',
  },
  {
...
export const articles: Article[] = [
  ...
  {
    title: 'L\'Informatique Quantique sur la Scène Mondiale',
    description:
      'Examine comment la superposition, l\'intrication et les investissements mondiaux façonnent la course à l\'avantage quantique.',
