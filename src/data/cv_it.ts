export const personal = {
  ...
  title: 'Studente di AI & Management | Sviluppatore Software | Ricercatore AI Applicata | Specialista in Machine Learning | Ingegnere Full-Stack  | Specialista in Prompt Engineering | Scrittore | Tecnico di Laboratorio',
...
export const education: Education[] = [
  ...
  },
  {
    ...
    period: '2017 - 2021',
    details: ['Diploma di scuola superiore con un forte focus sulle scienze e sulla cooperazione internazionale.'],
  },
];
...
export const skills: Skill[] = [
  ...
  { name: 'Sviluppo Full-Stack', category: 'programming' },
  { name: 'Sviluppo Web App', category: 'programming' },
  { name: 'Sviluppo App Mobile', category: 'programming' },
  { name: 'Integrazione API', category: 'programming' },
  { name: 'Architettura Frontend', category: 'programming' },
  ...
  { name: 'Rilevamento Anomalie', category: 'ai' },
  { name: 'Metodi Ensemble', category: 'ai' },
  { name: 'XGBoost', category: 'ai' },
  { name: 'Analisi di Serie Temporali', category: 'ai' },
  { name: 'Isolation Forest', category: 'ai' },
  { name: 'Explainable AI', category: 'ai' },
  { name: 'Analisi dell\'Importanza delle Feature', category: 'ai' },
  { name: 'Analisi Telemetrica', category: 'ai' },
  { name: 'Valutazione dei Modelli', category: 'ai' },
  ...
  { name: 'Curazione dei Dataset', category: 'tools' },
  { name: 'Progettazione Sperimentale', category: 'tools' },
  { name: 'Documentazione Tecnica', category: 'tools' },
  { name: 'Benchmark di Ricerca', category: 'tools' },
  { name: 'Raccolta Dati di Laboratorio', category: 'tools' },
  { name: 'Saggi Long-form', category: 'writing' },
  { name: 'Comunicazione Tecnica', category: 'writing' },
  { name: 'Analisi delle Policy', category: 'writing' },
  { name: 'Sintesi della Ricerca', category: 'writing' },
  { name: 'Scrittura Editoriale', category: 'writing' },
  { name: 'Critica Socio-Tecnica', category: 'writing' },
  { name: 'Scrittura Argomentativa', category: 'writing' },
  { name: 'Commento Tecnologico', category: 'writing' },
  { name: 'Analisi Macroeconomica', category: 'writing' },
  { name: 'Analisi Filosofica', category: 'writing' },
  { name: 'Strutturazione Narrativa', category: 'writing' },
  { name: 'Teamwork', category: 'soft' },
  { name: 'Vice-Presidente MUN', category: 'soft' },
  { name: 'Multilingue', category: 'soft' },
  { name: 'Ricerca', category: 'soft' },
  { name: 'Leadership', category: 'soft' },
  { name: 'Adattabilità', category: 'soft' },
  { name: 'Comunicazione Interculturale', category: 'soft' },
  { name: 'Public Speaking', category: 'soft' },
  { name: 'Pensiero Strategico', category: 'soft' },
];
...
export const awards: Award[] = [
  {
    title: 'LUISS Grand Challenge – 1° Posto',
    issuer: 'Poste Italiane & LUISS',
    detail: 'Corso e competizione universitaria',
  },
  {
...
export const articles: Article[] = [
  ...
  {
    title: 'Il Quantum Computing sulla Scena Globale',
    description:
      'Esamina come la sovrapposizione, l\'entanglement e gli investimenti globali plasmano la corsa al vantaggio quantistico.',
